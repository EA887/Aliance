...
<body>
  ...
  <!-- /.navbar -->
  <section class="section section-avtohim">
    <div class="container avtohim-inner">
      <div class="avtohim-content">
        <div class="avtohim-grid">
          <div class="avtohim-text-block">
            <div class="separator"></div>
            <h2 class="avtohim-title">Автохимия <span class="agtech-bold">AG-Tech</span></h2>
            <nav class="breadcrumbs" aria-label="Хлебные крошки">
              <a href="./" class="breadcrumbs-link">Главная</a>
              <span class="breadcrumbs-separator">—</span>
              <span class="breadcrumbs-menu">Собственные торговые марки</span>
              <span class="breadcrumbs-separator">—</span>
              <span class="breadcrumbs-current">Автохимия AG-Tech</span>
            </nav>
          </div>
          <div class="avtohim-image-wrapper">
            <img src="img/avto.png" alt="Автомобильная химия AG-Tech" class="avtohim-img">
          </div>
        </div>

...
<body class="front-page">
  ...
  <nav class="navbar">
    ...
    <ul class="header-nav">
      ...
      <li class="header-nav-item">
        <a href="/product.html" class="header-nav-link">Собственные торговые марки</a>
      </li>
      <li class="header-nav-item">
    ...
    <div class="container">
      ...
      <div class="cards">
        ...
        <a href="#" class="card">
          ...
          <!-- /.card-content -->
          <img src="img/home-him.png" alt="Бытовая химия" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
          ...
          <!-- /.card-content -->
          <img src="img/dezinfect-him.png" alt="Дезинфицирующие средства" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
          ...
          <!-- /.card-contant -->
          <img src="img/dezinfect-him.png" alt="Пищевые аэрозоли" class="card-image">
        </a>
        <a href="#" class="card">
          <div class="card-content">
        ...
        <a href="#" class="card">
          ...
          <!-- /.card-content -->
          <img src="img/home-him.png" alt="Краски аэрозольные" class="card-image">
        </a>
      </div>
    </div>
  </section>
  <section class="section-stamp">
    <div class="container">
      <div class="separator"></div>
      ...
      <div class="stamps">
        <div class="stamp">
          ...
          <h3 class="stamp-title">Автохимия AG-Tech</h3>
          <p class="stamp-text">
        ...
        <div class="stamp">
          ...
          <h3 class="stamp-title">Автохимия AP</h3>
          <p class="stamp-text">
            Для современного мира разбавленное изрядной долей эмпатии, рациональное мышление создаёт предпосылки для
            поставленных
            обществом задач.
      ...
      <div class="clients-wrapper">
        <div class="clients-content">
          ...
          <ul class="clients-list">
            ...
            <li class="clients-list-item">
              <svg width="30" height="30" class="clients-list-icon">
                <use href="img/sprite.svg#shrit"></use>
              </svg>

  ...
  <section class="section section-blog">
    <div class="container blog-inner">
      <div class="blog-content">
        ...
        <h2 class="blog-title">Современная методология разработки одухотворила всех причастных</h2>
        <nav class="breadcrumbs" aria-label="Хлебные крошки">
          <a href="./" class="breadcrumbs-link">Главная</a>
          <span class="breadcrumbs-separator-blog">—</span>
          <span class="breadcrumbs-blog">Блог</span>
          <span class="breadcrumbs-separator-blog">—</span>
          <span class="breadcrumbs-blog">Современная методология разработки одухотворила всех причастных</span>
        </nav>
      </div>
    </div>
  </section>
